...
router.post('/create', (0, Joi_1.ValidateJoi)(Joi_1.Schemas.book.create), BookController_1.default.createBook);
router.get('/get/:bookId', BookController_1.default.readBook);
router.get('/get/', BookController_1.default.readAll);
router.patch('/update/:bookId', (0, Joi_1.ValidateJoi)(Joi_1.Schemas.book.update), BookController_1.default.updateBook);
